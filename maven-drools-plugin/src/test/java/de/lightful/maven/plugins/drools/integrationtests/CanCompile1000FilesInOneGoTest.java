...
@Test
@DefaultSettingsFile
@VerifyUsingProject("can_compile_1000_files_in_one_go")
@ExecuteGoals("clean")
public class CanCompile1000FilesInOneGoTest extends MavenVerifierTest {
  ...
  public void testPackageFileContainsAllTheExpectedRules() throws Exception {
    ...
    assertThat(knowledgePackages).as("Knowledge packages").hasSize(1000);
    ...
    for (int packageNumber = 1; packageNumber <= 1000; packageNumber++) {
